...
<div style="display: block; text-align: center;">
    ...
    <c:if test="${paging.startPage != 1 }">
       <li class="page-item" ><a class="page-link" href="/hotel/admin/query/queryList?nowPage=${paging.startPage - 1 }&cntPerPage=${paging.cntPerPage}">&lt;</a></li>
    </c:if>
    <c:forEach begin="${paging.startPage }" end="${paging.endPage }" var="p">
       <c:choose>
          ...
          <c:when test="${p != paging.nowPage }">
             <li class="page-item"  ><a class="page-link" href="/hotel/admin/query/queryList?nowPage=${p }&cntPerPage=${paging.cntPerPage}">${p }</a></li>
          </c:when>
          
       </c:choose>
    </c:forEach>
    <c:if test="${paging.endPage != paging.lastPage}">
       <li class="page-item"  ><a class="page-link" href="/hotel/admin/query/queryList?nowPage=${paging.endPage+1 }&cntPerPage=${paging.cntPerPage}">&gt;</a></li>
    </c:if>
    </ul> 
    </nav> 
