...
<div class="container">
	...
	<!-- $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ Mypage $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ -->
	<div class='title'>
		<a href='../common/myPage' style="text-decoration: none"><h1>
	...
	<nav class='navbar navbar-default' style='background-color: #0B2161'
		...
		<div class='container-fluid'>
			<ul class='nav navbar-nav'>
				<li><a style='color: #FFFFFF' href='./resMy'>예약 내역</a></li>
				<li><a style='color: #FFFFFF' href='../refund/refundMy'>환불
						내역</a></li>
				<li><a style='color: #FFFFFF' href='../review/reviewMy'>후기
						내역</a></li>
				<li><a style='color: #FFFFFF' href='../query/queryMypage'>문의
						내역</a></li>
				<li><a style='color: #FFFFFF' href='../user/userInfo'>회원 정보
						관리</a></li>
			</ul>
		</div>
	</nav>
	...
	<table class='table' style="margin: auto;">
		...
		<tbody id="resList">
			<c:forEach var="res" items="${reservations}">
				<c:if test="${sessionScope.user.userId == res.userId}">
					<tr>
						<td style="padding: 15px;">${res.resNum}</td>
						<td style="vertical-align: middle;">${res.resChkin}</td>
			...
			<ul class='pagination'>
				<c:if test="${paging.startPage != 1 }">
					<li class="page-item"><a class="page-link"
						href="./resMy?nowPage=${paging.startPage - 1 }&cntPerPage=${paging.cntPerPage}">&lt;</a></li>
				</c:if>
				<c:forEach begin="${paging.startPage }" end="${paging.endPage }"
					...
					<c:choose>
						...
						<c:when test="${p != paging.nowPage }">
							<li class="page-item"><a class="page-link"
								href="./resMy?nowPage=${p }&cntPerPage=${paging.cntPerPage}">${p }</a></li>
						</c:when>
				...
				<c:if test="${paging.endPage != paging.lastPage}">
					<li class="page-item"><a class="page-link"
						href="./resMy?nowPage=${paging.endPage+1 }&cntPerPage=${paging.cntPerPage}">&gt;</a></li>
				</c:if>
			</ul>
		</nav>
	</div>
